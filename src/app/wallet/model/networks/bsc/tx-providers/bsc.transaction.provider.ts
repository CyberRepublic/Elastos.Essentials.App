...
export class BSCTransactionProvider extends EVMTransactionProvider {
  ...
  protected createEVMSubWalletProvider(mainCoinSubWallet: AnyMainCoinEVMSubWallet) {
    if (this.useNownode(mainCoinSubWallet)) {
      Logger.log('wallet', 'BSCTransactionProvider: Using NownodeEVMSubWalletProvider');
      this.mainProvider = new NownodeEVMSubWalletProvider(this, mainCoinSubWallet);
    } else {
      Logger.log('wallet', 'BSCTransactionProvider: Using EtherscanEVMSubWalletProvider');
  ...
  protected createEVMTokenSubWalletProvider(mainCoinSubWallet: AnyMainCoinEVMSubWallet) {
    if (this.useNownode(mainCoinSubWallet)) {
      Logger.log('wallet', 'BSCTransactionProvider: Using NownodeEVMSubWalletTokenProvider');
      this.tokenProvider = new NownodeEVMSubWalletTokenProvider(this, mainCoinSubWallet);
    } else {
      Logger.log('wallet', 'BSCTransactionProvider: Using EtherscanEVMSubWalletTokenProvider');
  ...
  protected createEVMSubWalletInternalTransactionProvider(mainCoinSubWallet: AnyMainCoinEVMSubWallet) {
    if (this.useNownode(mainCoinSubWallet)) {
      Logger.log('wallet', 'BSCTransactionProvider: Using NownodeEVMSubWalletInternalTransactionProvider');
      this.internalTXProvider = null;//new NownodeEVMSubWalletInternalTransactionProvider(this, mainCoinSubWallet);
    } else {
      Logger.log('wallet', 'BSCTransactionProvider: Using EtherscanEVMSubWalletInternalTransactionProvider');
