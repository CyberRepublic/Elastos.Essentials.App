  ...
  public async newNetworkWallet(masterWallet: MasterWallet): Promise<AnyNetworkWallet> {
    ...
    switch (masterWallet.type) {
      case WalletType.STANDARD:
        ...
        const StandardBTCNetworkWallet = (await import('../networkwallets/standard/standard.btc.networkwallet'))
          .StandardBTCNetworkWallet;
      ...
      case WalletType.LEDGER:
        ...
        const LedgerBTCNetworkWallet = (await import('../networkwallets/ledger/ledger.btc.networkwallet'))
          .LedgerBTCNetworkWallet;
