...
export class GlobalCosmosService {
  ...
  private async initCosmosClient() {
    ...
    let rpcUrl = WalletNetworkService.instance.activeNetwork.value.getRPCUrl();
    ...
    this.signingStargateClient = await SigningStargateClient.connectWithSigner(rpcUrl, wallet, {
