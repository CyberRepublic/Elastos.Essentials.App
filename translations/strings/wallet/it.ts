export const it = {
  wallet: {
    ...
    "find-new-token-msg":
      "Nuova moneta {{ token }} trovata nella rete {{ network }}",
    "find-new-tokens-msg":
      "{{ count }} nuove monete trovate nella rete {{ network }}",
    ...
    "eth-insuff-balance":
      "Non hai abbastanza {{coinName}} per pagare le commissioni di questa transazione token",
    "sync-completed": "Sincronizzazione completata",
    "not-a-valid-address": "Non è un indirizzo valido",
    "transaction-pending":
      "C'è già una transazione in corso. Attendi la conferma della transazione.",
    ...
    "hive-not-configured-text":
      "Il tuo spazio di archiviazione Hive non è configurato. Vuoi configurarlo ora?",
    ...
    "settings-my-wallets-subtitle":
      "Esegui il backup dei tuoi portafogli e accedi alle loro impostazioni",
    ...
    "settings-custom-networks-subtitle":
      "Aggiungi e modifica le tue reti personalizzate qui",
    ...
    "settings-add-wallet-create-aa-wallet": "Crea Portafoglio AA",
    ...
    "coin-new-transactions-today":
      "{{todaysTransactions}} NUOVE/A TRANSAZIONI/E OGGI",
    "coin-balance": "Saldo",
    ...
    "coin-dir-to-mainchain": "A Main Chain",
    ...
    "touch-to-select-a-personal-wallet":
      "Tocca per scegliere un portafoglio personale",
    "withdraw-note":
      "L'importo minimo di prelievo è 0,0002 ELA e deve essere un multiplo intero di 0,00000001",
    "crosschain-note":
    ...
    "coin-address-copied":
      "Indirizzo del tuo portafoglio {{coinName}} copiato!",
    ...
    "network-switch-component-intro":
      "Per continuare, devi passare ad un'altra rete.",
    ...
    "eth-transaction-speedup-prompt":
      "Puoi velocizzare la transazione aumentando il prezzo del gas",
    ...
    "wallet-settings-backup-wallet-subtitle":
      "Visualizza il tuo mnemonico per salvarlo in un luogo sicuro.",
    "wallet-settings-backup-wallet-export":
      "Esporta mnemonico e chiave privata EVM",
    ...
    "wallet-settings-consolidate-utxos-subtitle":
      "Troppi utxos aumenteranno il tempo per creare transazioni.",
    ...
    "coin-adderc20-not-a-erc20-contract":
      "L'indirizzo del token ERC20 fornito non è valido.",
    ...
    "custom-networks-intro":
      "Gestisci qui le tue reti compatibili con EVM (Ethereum).",
    ...
    "wrong-rpc-url":
      "L'URL RPC fornito non può essere contattato e potrebbe essere errato. Per favore ricontrollalo.",
    ...
    "cant-delete-active-network":
      "La rete attiva non può essere eliminata. Scegli prima un'altra rete.",
    ...
    "nft-collectibles-cant-be-listed":
      "Le risorse per questo tipo di NFT non possono essere elencate.",
    "nft-unnamed-asset": "NFT senza nome",
    "nft-asset-with-type": "NFT di tipo {{ type }}",
    "nft-properties": "Proprietà",
    "nft-no-properties-yet":
      "La visualizzazione delle proprietà sarà presto disponibile.",
    ...
    "access-request-for-info":
      "Questa è una richiesta per accedere alle informazioni sul tuo portafoglio.",
    ...
    "didtransaction-transaction-fee":
      "Questo costerà una piccola commissione di transazione",
    "didtransaction-intro":
      "Stai per pubblicare la tua identità sulla chain pubblica.",
    ...
    "vote-transaction-fees":
      "Verrà addebitata una commissione di transazione di 0,0001 ELA",
    "vote-revote":
    ...
    "esctransaction-intro":
      "Stai per firmare ed eseguire un contratto intelligente.",
    ...
    "intent-no-wallet-msg":
      "Sembra che tu non abbia un portafoglio. Vuoi crearlo ora?",
    ...
    "import-wallet-by-privatekey":
      "Importa il portafoglio tramite Chiave Privata EVM",
    ...
    "type-menmonic-verify":
      "Inserisci le tue 12 parole di sicurezza (il tuo mnemonico) per verificarle.",
    "type-menmonic-import":
      "Inserisci le parole del tuo mnemonico per importare il tuo portafoglio. ",
    ...
    "mnemonic-import-missing-words":
      "Per favore inserisci tutte le parole prima di continuare",
    ...
    "mnemonic-verify-fail":
      "Il mnemonico non è corretto, inseriscilo di nuovo.",
    "mnemonic-input-passphrase":
      "Inserisci la Passphrase da associare al tuo Mnemonico",
    ...
    "import-wallet-by-keystore-info":
      "Keystore: È supportato solo il keystore ELA",
