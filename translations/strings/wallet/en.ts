export const en = {
    ...
    'wallet': {
        ...
        *******************/
        ...
        "find-new-tokens-warning-msg": "Note: please pay attention, some tokens can be malicious. Only use them if you know them.",
        "nft-name": "Name",
        ...
        ******************/
        ...
        "coin-op-cr-register": "Elastos DAO Registration",
        "coin-op-cr-cancel": "Elastos DAO Cancellation",
        "coin-op-cr-update": "Elastos DAO Update",
        "coin-op-cr-return": "Elastos DAO Deposit Retrieve",
        ...
        *****************/
        ...
        "export-private-key-intro": "Optionally, you can also use the following evm private key in some wallets. Touch to copy.",
        ...
        ****************************/
        ...
        'text-consolidate-note-ledger': 'Too many UTXOs may cause some transactions to fail. The Ledger wallet can only consolidate {{ count }} UTXOs at a time.',
