  ...
  wallet: {
    ...
    aa: {
      create: {
        ...
        provider: "Provider",
        "provider-placeholder": "Select the AA wallet provider",
        "account-address": "AA Account Address",
        "account-address-placeholder":
          "AA account address is automatically detected",
        "account-address-help":
          "Account address is automatically detected for the selected chain",
