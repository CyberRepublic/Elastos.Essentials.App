export const zh = {
  wallet: {
    ...
    "find-new-tokens-warning-msg":
      "备注：请注意，某些代币可能是恶意的。仅当您了解它们后才去使用它们。",
    "nft-name": "名称",
    "nft-description": "描述",
    ...
    "eth-insuff-balance":
      "您必须有足够的 {{ coinName }} 来支付gas费，才能发送此代币",
    ...
    "settings-add-wallet-create-aa-wallet": "创建AA钱包",
    ...
    "crosschain-note":
      "Elastos跨链转账一般需要15到25分钟。在此期间，您将无法看到这笔资金，请耐心等待",
    ...
    "burn-bpos-nft-transaction-prompt":
      "BPoS NFT 被销毁大约12分钟后，对应的BPoS投票 将转至 Elastos 主链",
    ...
    "ledger-prompt":
      "请开启 Ledger Nano X，保持解锁，并打开 {{appname}} 应用程序",
    "ledger-connected-device": "已连接设备",
    "ledger-confirm-on-ledger-prompt":
      "点击 继续 后，请在 Ledger 上查看交易并确认！",
    ...
    "delete-wallet-confirm-subtitle":
      "您的钱包将从此设备上删除。 您可以重新导入此钱包，请确保已经备份好钱包助记词。",
    ...
    "notification-found-one-claimable-nft":
      "钱包 {{ walletname }} 在 Elastos Smart Chain 上有 1 个可申领的 BPoS NFT！",
    ...
    "esctransaction-approve-token-intro":
      "此应用程序或网站将被允许代表您提取和使用您的 {{token}} 代币",
    ...
    "signbitcoindata-danger":
      "只有在您知道自己在做什么或完全信任请求网站的情况下，才能签署此交易。",
    "signbitcoindata-enable-signdata-request":
      "这个请求可能很危险。 请先在Essentials设置中启用开发者模式，并激活 Bitcoin signData()功能",
    ...
    "pushbitcointx-danger":
      "只有在您知道自己在做什么或完全信任请求网站的情况下，才能发布此交易。",
     ...
     *****************/
    "mnemonic-prompt1":
      "这是您的12个安全字（助记词）。丢失这些，您将丢失钱包，因此必须将它们",
    ...
    "mnemonic-warning3":
      "切勿与任何人分享您的助记词，并始终保持安全！确保没有人在看着您再继续",
    ...
    "multi-sig-tx-unknown-network":
      "抱歉，您的 Essentials 版本中不存在此交易适用的网络。",
    ...
    "multi-sig-extended-public-key-info":
      "这是您的扩展公钥。您可以将此密钥用作多签钱包的联合签名者密钥。",
    ...
    "resource-freeze-note":
      "完成TRX质押后可随时解冻，解冻后需要等待14天，才可以将解冻的本金提取到自己的账户中",
    "resource-unfreeze-note":
      "解冻后需要等待14天，才可以将解冻的本金提取到自己的账户中",
