export const fr = {
  wallet: {
    ...
    "personal-wallets-with":
      "Portefeuille personnel avec {{ subwalletSymbol }}",
    "find-new-token": "Nouveau Jeton",
    "find-new-token-msg":
      "Nouveau jeton {{ token }} trouvé sur le réseau {{ network }}",
    "find-new-tokens-msg":
      "{{ count }} nouveaux jetons trouvés sur le réseau {{ network }}",
    ...
    "eth-insuff-balance":
      "Vous n'avez pas suffisamment d'{{ coinName }} pour payer cette transaction de jetons",
    ...
    "settings-my-wallets-subtitle":
      "Sauvegardez vos portefeuilles et accédez à leurs paramètres",
    ...
    "settings-custom-networks-subtitle":
      "Ajoutez et modifiez vos réseaux personnalisés ici",
    "settings-manage-networks": "Gestion des Réseaux",
    "settings-manage-networks-subtitle":
      "Affichez et cachez certains réseaux, et ajoutez des réseaux personnalisés",
    ...
    "coin-new-transactions-today":
      "{{ todaysTransactions }} NOUVELLE(S) TRANSACTION(S) AUJOURD'HUI",
    "coin-balance": "Solde",
    ...
    "transfer-receiver-address-placeholder":
      "Veuillez entrer l'adresse de destination",
    ...
    "transfer-all": "Tous",
    max: "MAX",
    "touch-to-select-a-personal-wallet":
      "Toucher pour choisir un portefeuille personnel",
    "withdraw-note":
      "Le retrait minimal est de 0.0002 ELA et doit être un multiple de 0.00000001",
    "crosschain-note":
    ...
    "network-switch-component-intro":
      "Pour continuer, vous devez passer sur un réseau différent.",
    ...
    "eth-transaction-speedup-prompt":
      "Vous pouvez accélérer la transaction en augmentant le prix du gas",
    ...
    "ledger-scan-bluetooth-not-enable":
      "Le bluetooth est éteint, veuillez l'allumer",
    ...
    "wallet-settings-backup-wallet-subtitle":
      "Visualisez votre mnémonique pour le sauvegarder en lieu sûr.",
    "wallet-settings-backup-wallet-export":
      "Exporter clé papier et clé privée EVM",
    ...
    "wallet-settings-change-name-subtitle":
      "Organisez vos portefeuilles en leur donnant un nom personnalisé.",
    "wallet-settings-change-theme": "Modifier le thème",
    "wallet-settings-change-theme-subtitle":
      "Organisez vos portefeuilles avec des couleurs personnalisées.",
    "wallet-settings-manage-coin-list": "Gérer la Liste des Jetons",
    "wallet-settings-manage-coin-list-subtitle":
      "Sélectionnez les jetons à gérer dans votre portefeuille.",
    ...
    "wallet-settings-consolidate-utxos-subtitle":
      "Trop d'utxo augmente le temps de création de la transaction",
    ...
    "coin-adderc20-not-a-erc20-contract":
      "Le contenu n'est pas une adresse de jeton ERC20 valide.",
    ...
    "custom-networks-intro":
      "Gérez vos propres réseaux compatibles EVM (Ethereum) ici.",
    ...
    "wrong-rpc-url":
      "L'url fournie n'a pas pu être contactée et est peut-être erronée. Veuillez la vérifier.",
    ...
    "nft-collectibles-cant-be-listed":
      "Les actifs pour ce type de NFT ne peuvent pas être listés.",
    "nft-unnamed-asset": "NFT sans nom",
    "nft-asset-with-type": "NFT de type {{ type }}",
    "nft-properties": "Propriétés",
    "nft-no-properties-yet":
      "L'affichage des propriétés sera disponible prochainement.",
    ...
    "access-request-for-info":
      "Ceci est une demande d'accès aux informations de votre portefeuille.",
    ...
    "didtransaction-transaction-fee":
      "Des frais de transaction mineurs s'appliquent",
    "didtransaction-intro":
      "Vous vous apprêtez à publier votre identité sur la châine publique.",
    ...
    "vote-transaction-fees":
      "Des frais de transaction de 0.0001 ELA seront prélevés",
    "vote-revote":
      "Pensez à voter à nouveau après avoir utilisé des ELA de votre portefeuille principal.",
    ...
    "esctransaction-intro":
      "Vous allez signer et éxécuter un contrat intelligent.",
    ...
    "intent-no-wallet-msg":
      "Vous n'avez pas de portefeuille, voulez-vous le créer maintenant?",
    ...
    "text-wallet-name-validator-enter-name":
      "Veuillez saisir un nom pour votre portefeuille",
    "text-wallet-name-validator-not-valid-name":
      "Le nom saisi n'est pas valide",
    "text-wallet-name-validator-already-exists":
      "Ce nom est déjà utilisé par un autre portefeuille",
    "text-wallet-passphrase-validator-repeat":
      "Les deux phrases secrètes saisies sont différentes",
    "text-wallet-passphrase-validator-min-length":
      "La phrase secrète doit avoir au moins 8 caractères",
    ...
    "type-menmonic-verify":
      "Veuillez saisir vos 12 mots de sécurité (Votre mnémonique) afin de les vérifier.",
    "type-menmonic-import":
      "Saisissez les mots de votre mnémonique pour importer votre portefeuille.",
    ...
    "mnemonic-import-missing-words":
      "Veuillez saisir tous les mots avant de continuer",
    ...
    "mnemonic-verify-fail":
      "Le mnémonique est incorrect, veuillez le saisir à nouveau.",
    ...
    "import-paste-from-keypad":
      "Note: vous pouvez coller une clé papier en entier depuis le clavier",
    ...
    "import-wallet-by-keystore-info":
      "Keystore: seul les keystore elastos sont supportés",
    ...
    "multi-sig-error-no-signing-wallet":
      "Veuillez choisir un portefeuille avec lequel vous signerez les transactions",
    "multi-sig-error-invalid-xpub": "Veuillez saisir une clé xpub vqlide",
    "multi-sig-error-xpub-in-user":
      "Cette clé est déjà dans la liste, veuillez en choisir une autre",
    ...
    "multi-signature-transaction-link-copied":
      "Le lien a été copié dans le press-papier",
    ...
    "multi-sig-tx-unknown-network":
      "Cette transaction est pour un réseau non supporté par votre version d'Essentials.",
    "multi-sig-tx-pick-wallet":
      "Choisissez le portefeuille multi-signatures à utiliser.",
    ...
    "ext-tx-info-type-add-liquidity-with-symbols":
      "Ajout de {{ symbolA }} + {{ symbolB }} LP",
    "ext-tx-info-type-add-liquidity-with-one-symbols":
      "Ajout de {{ symbolA }} LP",
    "ext-tx-info-type-remove-liquidity": "Retrait de liquidités",
    "ext-tx-info-type-remove-liquidity-with-symbols":
      "Retrait de {{ symbolA }} + {{ symbolB }} LP",
