export const fr = {
    ...
    'dposvoting': {
        ...
        'dpos-node-info-no-available' : 'The Node\'s info is not available at this time, please try again later',
        ...
        'retrieve': 'Récupérer',
        'illegal': 'Noeud illégal',
        'return': 'Désenregistré avec succès',
        'node-status': 'Statut Noeud',
        'node-name': 'Nom du Noeud',
        'node-publickey': 'Clé Publique du Noeud',
        'node-publickey-note': 'Veuillez obtenir la clé publique du noeud à partir du serveur du noeud',
        'required-placeholder': 'Required',
        'node-location': 'Localisation du Noeud',
        'node-location-placeholder': 'Select node location',
        'node-url': 'URL du Noeud',
        'registration-confirm': 'Confirmer',
        'dpos-node-info': 'Infos du noeud',
        'back': 'retour',
        'state': 'Statut:',
        'Pending': 'Pending',
        'Active': 'Active',
        ...
        'reg-dpos-balance-not-enough': 'Un dépôt de 2000 ELA ainsi que des frais de transaction mineurs sont requis pour l\'enregistrement d\'un noeud BPoS',
