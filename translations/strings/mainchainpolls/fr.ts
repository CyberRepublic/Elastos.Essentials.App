export const fr = {
  mainchainpolls: {
    title: 'Vote Elastos',
    intro: 'Participez aux sondages de la chaîne principale en votant avec votre ELA. Votre vote est enregistré sur la chaîne dans les mémos des transactions.',
